class CoinModel {
  ...
  factory CoinModel.fromJson(dynamic json) {
    return CoinModel(
      ...
      priceChangePercentage24h: json['market_data']['price_change_percentage_24h'] as num,
      marketCap: json['market_data']['market_cap']['usd'] as num,
      marketCapChangePercentage24h: json['market_data']['market_cap_change_percentage_24h_in_currency']['usd'] as num,
  ...
  static CoinModel coinFromSnapshot(dynamic snapshot) {
    return CoinModel.fromJson(snapshot);
  }
}
